...
Section:NewButton("Arceus x Fly V3", "Fly Gui", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/YxuTeam/ARCEUS-X/main/Arceus%20X%20FLY.lua"))()
end)
...
Section:NewButton("Free Gamepasses", "gui with few games", function()
    -- Gui to Lua
-- Version: 3.2
...
local Tab = Window:NewTab("Flee The Faccility")
local Section = Tab:NewSection("Gui")


Section:NewButton("Flee The Facillity", "Gui", function()
